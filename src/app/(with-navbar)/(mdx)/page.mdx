...
Each assignment will be graded out of 75 for correctness, and 25 for best practices. ESLint errors will be scored deductively, with a max of -15 points. Check the <Link href={STYLE_ROUTE}>style page</Link> for guidelines.
