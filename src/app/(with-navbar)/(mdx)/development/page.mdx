...
- Install ESLint, Prettier, and our config into your project by running:

```sh
npm install -D eslint@latest prettier@latest @cis-1962/eslint-config@latest
```

- Start with one of our `.eslintrc.js` templates found [on GitHub](https://github.com/cis-1962/eslint-config) to use our ESLint rules.
- Create a file called `.prettierrc.json` at the root directory. Copy and paste [this file](/reference/prettier-config.json).
